-- Migration 075: Repair portal_homework_plans + portal_homework_plan_tasks
-- Migration 020 was skipped because tenant db_version was already > 20.
...
CREATE TABLE IF NOT EXISTS `portal_homework_plan_tasks` (
    ...
    CONSTRAINT `fk_phpt_plan_075` FOREIGN KEY (`plan_id`) REFERENCES `portal_homework_plans` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
