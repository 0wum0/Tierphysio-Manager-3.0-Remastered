...
class MobileApiController
{
    ...
    public function dashboard(array $params = []): void
    {
        ...
        $this->json([
            ...
            'practice_type'     => $settings['practice_type'] ?? 'therapeut',
            'is_trainer'        => ($settings['practice_type'] ?? 'therapeut') === 'trainer',
            'user_name'         => $userName,
            ...
            'revenue_week'      => round($stats['revenue_week'] ?? 0, 2),
            'revenue_total'     => round($stats['revenue_total'] ?? 0, 2),
            'month_change'      => (float)($stats['month_change'] ?? 0),
            'year_change'       => (float)($stats['year_change'] ?? 0),
            'paid_count'        => (int)($stats['paid_count'] ?? 0),
            'draft_count'       => (int)($stats['draft_count'] ?? 0),
            'cancelled_count'   => (int)($stats['cancelled_count'] ?? 0),
            'cancelled_gross'   => round((float)($stats['cancelled_gross'] ?? 0), 2),
