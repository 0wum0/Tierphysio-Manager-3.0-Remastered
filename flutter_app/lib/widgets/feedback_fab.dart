...
class _FeedbackSheetState extends State<_FeedbackSheet> {
  ...
  Future<void> _send() async {
    ...
    if (!mounted) return;
    setState(() { _sending = false; _sent = ok; _error = ok ? null : 'Konnte nicht gesendet werden. Bitte prüfe deine Verbindung.'; });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: SafeArea(
          child: _sent ? _buildSuccess(textColor) : _buildForm(theme, textColor, isDark),
        ),
      ),
    );
  }
        ...
        children: [
          ...
          Wrap(
            ...
            children: _categories.map((cat) {
              ...
              return ChoiceChip(
                label: Text('$icon $label', style: TextStyle(fontSize: 13, color: selected ? Colors.white : textColor)),
                selected: selected,
                selectedColor: const Color(0xFF6EA8FE),
                backgroundColor: chipBg,
                side: BorderSide(color: selected ? const Color(0xFF6EA8FE) : borderColor),
          ...
          if (_category == 'praise' || _category == 'other') ...[
            Text('Bewertung (optional)', style: TextStyle(fontSize: 13, color: textColor.withOpacity(.6))),
                ...
                return GestureDetector(
                  ...
                  child: Padding(
                    ...
                    child: Icon(
                      ...
                      color: (_rating ?? 0) >= star ? const Color(0xFFFDE68A) : borderColor,
                      size: 32,
                    ),
                  ),
                );
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText: _category == 'bug'
                  ...
                  : _category == 'feature'
                      ...
                      : _category == 'praise'
                          ...
                          : 'Deine Nachricht…',
              hintStyle: TextStyle(color: textColor.withOpacity(.35), fontSize: 13),
              filled: true,
              ...
              counterStyle: TextStyle(color: textColor.withOpacity(.35), fontSize: 11),
            ),
          ),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: _sending
                  ...
                  : const Text('Feedback senden', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15)),
            ),
          ),
        ],
      ),
