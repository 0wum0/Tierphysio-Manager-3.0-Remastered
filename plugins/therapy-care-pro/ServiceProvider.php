...
class ServiceProvider
{
    public function register(PluginManager $pluginManager): void
    {
        ...
        $navItems[] = [
            ...
            'label_trainer' => 'TrainerCare Pro',           // Sichtbar in der Hundeschul-/Trainer-UI
            'href'          => '/tcp/admin/einstellungen',
            'href_trainer'  => '/tcp/bibliothek',           // Trainer: Admin-Settings ist per denyIfTrainer gesperrt → direkt in die Übungs-Bibliothek leiten
            'feature'       => 'therapy_care',
            /* kein practice_only mehr: TCP-Kern (Fortschritt, Übungs-Bibliothek,
             * Erinnerungen) ist auch für Trainer nutzbar; nur Naturheilkunde
             * und Therapieberichte werden im Controller/Template per
             * denyIfTrainer bzw. Twig-Gate ausgeblendet. */
